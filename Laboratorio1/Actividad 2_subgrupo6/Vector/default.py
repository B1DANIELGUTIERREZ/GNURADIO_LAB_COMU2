...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._samp_rate_range = Range(12500000/32, 12500000/2, 10000, 12500000/2, 200)
        self._samp_rate_win = RangeWidget(self._samp_rate_range, self.set_samp_rate, "fs", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._fc_range = Range(88000000, 108000000, 100000, 91700000, 200)
