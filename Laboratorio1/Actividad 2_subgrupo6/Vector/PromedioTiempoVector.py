...
import PromedioTiempoVector_epy_block_0 as epy_block_0  # embedded python block



from gnuradio import qtgui

class PromedioTiempoVector(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "PromedioTiempoVector")
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_f((5 ,2, 1), True, 1, [])
...
def main(top_block_cls=PromedioTiempoVector, options=None):
