...
import PromedioTiempoRuido_epy_block_0 as epy_block_0  # embedded python block



from gnuradio import qtgui

class PromedioTiempoRuido(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "PromedioTiempoRuido")
        ...
        self._GX_range = Range(1, 5, 1, 1, 200)
        self._GX_win = RangeWidget(self._GX_range, self.set_GX, "GANANCI", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.uhd_usrp_source_0.set_gain(GX, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_complex_to_imag_0, 0), (self.epy_block_0, 0))
        ...
        self.connect((self.uhd_usrp_source_0, 0), (self.blocks_complex_to_imag_0, 0))
    ...
    def set_GX(self, GX):
        self.GX = GX
        self.uhd_usrp_source_0.set_gain(self.GX, 0)




def main(top_block_cls=PromedioTiempoRuido, options=None):
