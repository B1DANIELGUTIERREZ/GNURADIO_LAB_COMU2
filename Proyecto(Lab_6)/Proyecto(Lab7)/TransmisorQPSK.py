...
class TransmisorQPSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.tabla_de_verdad_constelacion = tabla_de_verdad_constelacion = (-0.7-0.7j,-0.7+0.7j,0.7+0.7j,0.7-0.7j)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/labcom/Escritorio/Gurpo6_B1/Proyecto(Lab7)/Desde septiembre se siente que viene diciembre , Mike Char olímpica estereo.mp3', True, 0, 0)
        ...
        self.E3TRadio_diezmador_cc_1 = E3TRadio.diezmador_cc(3)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.E3TRadio_diezmador_cc_1, 0), (self.b_demod_constelacion_cb_0, 0))
        self.connect((self.analog_noise_source_x_0, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.b_demod_constelacion_cb_0, 0), (self.b_u_de_M_PAM_bb_0, 0))
        self.connect((self.b_u_de_M_PAM_bb_0, 0), (self.blocks_interleaved_char_to_complex_0, 0))
        ...
        self.connect((self.blocks_interleaved_char_to_complex_0, 0), (self.qtgui_const_sink_x_0_0_0, 0))
        self.connect((self.blocks_interleaved_char_to_complex_0, 0), (self.qtgui_freq_sink_x_0_0, 0))
        self.connect((self.blocks_interleaved_char_to_complex_0, 0), (self.qtgui_time_sink_x_0_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.E3TRadio_diezmador_cc_1, 0))
